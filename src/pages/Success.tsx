  ...
  return (
    <div className="flex min-h-[80vh] items-center justify-center animate-fade-in">
      <div className="max-w-md text-center px-4">
        ...
        <div className="mt-4 inline-flex items-center gap-1.5 rounded-full bg-lavender px-4 py-2 text-sm font-medium text-primary">
        ...
        <div className="mt-8 rounded-xl border border-border bg-card p-5">
          <div className="flex items-center justify-center gap-3 text-sm text-muted-foreground">
            ...
            <span>Your order is being prepared and will be shipped soon.</span>
          </div>
        </div>
